<template>
    <div class="mb-4">
        ...
        <select :id="id" :value="modelValue" @change="$emit('update:modelValue', $event.target.value)"
            :required="required"
            class="w-full border bg-white dark:bg-neutral-900 border-neutral-300 dark:border-neutral-600 text-gray-900 dark:text-gray-100 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
            v-bind="$attrs">
