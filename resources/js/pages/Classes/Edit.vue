<template>
    <AppLayout :breadcrumbs="[{ title: 'Classes', href: '/classes' }, { title: 'Edit', href: '#' }]">

        <Head title="Edit Class" />
        <div class="max-w-xl mx-auto w-full px-2 sm:px-4 md:px-0 py-8">
            <h1 class="text-2xl font-bold mb-6 text-neutral-900 dark:text-neutral-100">Edit Class</h1>
...
const props = defineProps<{ class: { id: number; name: string } }>();
const form = useForm({ name: props.class.name });
