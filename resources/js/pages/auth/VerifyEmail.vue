        ...
        <div class="w-full max-w-6xl bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden m-2 md:m-0">
            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-12">
                <div class="w-full max-w-xs sm:max-w-md">
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-2 text-center md:text-left">Verify Email</h2>
                    <p class="text-gray-500 mb-4 md:mb-6 text-center md:text-left">Please verify your email address by clicking on the link we just emailed to you.</p>
